...
const deportes = [
  {
    nombre: "Voleibol",
    descripcion: "Torneos emocionantes de voleibol en equipos mixtos. ¡Demuestra tu talento en la cancha!",
    icon: Trophy,
    jugadores: "6 vs 6",
  },
  {
  ...
  {
    nombre: "Beisbol Five",
    descripcion: "La nueva modalidad urbana del béisbol. Sin bate, sin guante, ¡solo tus manos y mucha estrategia!",
    icon: CircleDot,
    jugadores: "5 vs 5",
  },
  {
  ...
  {
    nombre: "Ajedrez",
    descripcion: "Desafía tu mente en partidas estratégicas. La inteligencia también compite en el campamento.",
    icon: Brain,
    jugadores: "1 vs 1",
  },
  {
...
const equiposPuntuacion = [
  { nombre: "Equipo 1", dia1: 0, dia2: 0, dia3: 0, total: 0 },
  { nombre: "Equipo 2", dia1: 0, dia2: 0, dia3: 0, total: 0 },
  { nombre: "Equipo 3", dia1: 0, dia2: 0, dia3: 0, total: 0 },
  { nombre: "Equipo 4", dia1: 0, dia2: 0, dia3: 0, total: 0 },
];
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-border/50 bg-primary/5">
                      ...
                      <TableHead className="text-center text-foreground font-bold text-primary">Total 🪙</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
